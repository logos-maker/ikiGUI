...
# ikiGUI
The smallest cross platform audio plugin GUI library availible. Is about 550 lines of code in total. With a minimum of dependencies, and uses only old standard system libraries for maximum compability.
